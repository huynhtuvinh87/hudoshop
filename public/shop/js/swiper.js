            ...
            (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) && ("container" === v.params.touchEventsTarget ? v.container : v.wrapper).addClass("swiper-wp8-" + v.params.direction),
                ...
                v.updateClickedSlide = function(e) {
                    ...
                    if (v.clickedSlide = t,
                        ...
                        v.params.loop ? (i = a(v.clickedSlide).attr("data-swiper-slide-index"),
                            v.params.centeredSlides ? l < v.loopedSlides - v.params.slidesPerView / 2 ? (v.fixLoop(),
                                n = v.wrapper.children("." + v.params.slideClass + '[data-swiper-slide-index="' + i + '"]'),
                                l = n.eq(n.length - 1).index(),
                                setTimeout(function() {
                                    v.slideTo(l)
                                }, 0)) : l > v.slides.length - v.loopedSlides + v.params.slidesPerView / 2 ? (v.fixLoop(),
                                l = v.wrapper.children("." + v.params.slideClass + '[data-swiper-slide-index="' + i + '"]').eq(0).index(),
                                setTimeout(function() {
                                    v.slideTo(l)
                                }, 0)) : v.slideTo(l) : l > v.slides.length - v.params.slidesPerView ? (v.fixLoop(),
                                l = v.wrapper.children("." + v.params.slideClass + '[data-swiper-slide-index="' + i + '"]').eq(0).index(),
                                setTimeout(function() {
                                    v.slideTo(l)
                                }, 0)) : l < v.params.slidesPerView - 1 ? (v.fixLoop(),
                                n = v.wrapper.children("." + v.params.slideClass + '[data-swiper-slide-index="' + i + '"]'),
                                l = n.eq(n.length - 1).index(),
                                setTimeout(function() {
                                    v.slideTo(l)
            ...
            if (v.onTouchStart = function(e) {
                        ...
                        if (e.originalEvent && (e = e.originalEvent),
                            ...
                            if (v.params.onlyExternal)
                                return v.allowClick = !1,
                                    void (y && (v.touches.startX = v.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
                    ...
                    v.onTouchEnd = function(e) {
                        if (e.originalEvent && (e = e.originalEvent),
                                ...
                                y) {
                            v.params.grabCursor && b && y && (v.container[0].style.cursor = "move",
                                v.container[0].style.cursor = "-webkit-grab",
                                v.container[0].style.cursor = "-moz-grab",
                                v.container[0].style.cursor = "grab");
                            var t = Date.now()
                            ...
                            if (v.allowClick && (v.updateClickedSlide(e),
                                ...
                                !y || !b || !v.swipeDirection || 0 === v.touches.diff || S === C)
                                return void (y = b = !1);
                            y = b = !1;
                            var r;
                            if (r = v.params.followFinger ? v.rtl ? v.translate : -v.translate : -S,
                                ...
                                if (v.params.freeModeMomentum) {
                                    ...
                                    if (0 !== v.velocity)
                                        p = v.rtl ? Math.abs((-c - v.translate) / v.velocity) : Math.abs((c - v.translate) / v.velocity);
                                    else if (v.params.freeModeSticky)
                            ...
                            if (s > v.params.longSwipesMs) {
                                if (!v.params.longSwipes)
                                    return void v.slideTo(v.activeIndex);
                                "next" === v.swipeDirection && (I >= v.params.longSwipesRatio ? v.slideTo(T + v.params.slidesPerGroup) : v.slideTo(T)),
                                "prev" === v.swipeDirection && (I > 1 - v.params.longSwipesRatio ? v.slideTo(T + v.params.slidesPerGroup) : v.slideTo(T))
                            } else {
                            ...
                            setTranslate: function() {
                                for (var e = v.translate, t = r() ? -e + v.width / 2 : -e + v.height / 2, s = r() ? v.params.coverflow.rotate : -v.params.coverflow.rotate, i = v.params.coverflow.depth, n = 0, o = v.slides.length; o > n; n++) {
                                    ...
                                    if (l.transform(w),
                                        ...
                                        0 === y.length && (y = a('<div class="swiper-slide-shadow-' + (r() ? "left" : "top") + '"></div>'),
                                            l.append(y)),
                                        0 === b.length && (b = a('<div class="swiper-slide-shadow-' + (r() ? "right" : "bottom") + '"></div>'),
                                            l.append(b)),
                    ...
                    v.scrollbar = {
                        ...
                        dragEnd: function(e) {
                            ...
                            v.params.scrollbarHide && (clearTimeout(a.dragTimeout),
                        ...
                        setTranslate: function() {
                            if (v.params.scrollbar) {
                                ...
                                e = (a.trackSize - a.dragSize) * v.progress,
                                    ...
                                    r() ? (v.support.transforms3d ? a.drag.transform("translate3d(" + e + "px, 0, 0)") : a.drag.transform("translateX(" + e + "px)"),
                                        a.drag[0].style.width = t + "px") : (v.support.transforms3d ? a.drag.transform("translate3d(0px, " + e + "px, 0)") : a.drag.transform("translateY(" + e + "px)"),
                ...
                v.a11y = {
                    ...
                    onEnterKey: function(e) {
                        13 === e.keyCode && (a(e.target).is(v.params.nextButton) ? (v.onClickNext(e),
                            v.isEnd ? v.a11y.notify(v.params.lastSlideMessage) : v.a11y.notify(v.params.nextSlideMessage)) : a(e.target).is(v.params.prevButton) && (v.onClickPrev(e),
