...
<div class="content-wrapper" style="min-height: 1200.88px;">
    ...
    <section class="content">
        <form method="POST" action="{{ route('admin.affs.store') }}" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            <div class="row">
                <div class="col-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input id="content" type="text" class="form-control @error('content') is-invalid @enderror" name="content" value="{{ old('content') }}" class="form-control">
